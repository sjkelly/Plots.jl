...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(gr_set_line),Int64,Symbol,RGBA{Float64},Series})
    ...
    isdefined(Plots, Symbol("#299#335")) && Base.precompile(Tuple{getfield(Plots, Symbol("#299#335"))})
